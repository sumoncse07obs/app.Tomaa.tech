// src/components/admin/customer/YouTubePromptSettings.tsx
...
/* =========================
   DEFAULTS (prefill if blank)
   ========================= */
const DEFAULT_YOUTUBE_PROMPTS: Omit<
  PromptSetting,
...
/* =========================
   ...
   ========================= */
const ALL_KEYS = Object.keys(DEFAULT_YOUTUBE_PROMPTS) as FieldKey[];
const isBlank = (v: unknown) => v == null || (typeof v === "string" && v.trim() === "");

function withDefaults(src: Partial<PromptSetting> | null | undefined): Partial<PromptSetting> {
  const base: Partial<PromptSetting> = { ...DEFAULT_YOUTUBE_PROMPTS };
  if (!src) return base;
